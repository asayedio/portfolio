              ...
              >
                ...
                <div className={index % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:col-start-2 md:pl-12'}>
                  <div className="card">
                    ...
                    <div className={`flex items-center gap-2 text-primary-600 dark:text-primary-400 font-semibold mb-4 ${index % 2 === 0 ? 'md:justify-end' : ''}`}>
                      <FiBriefcase size={18} />
                      <span>{exp.company}</span>
                    </div>

                    <div className={`flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400 mb-4 ${index % 2 === 0 ? 'md:justify-end' : ''}`}>
